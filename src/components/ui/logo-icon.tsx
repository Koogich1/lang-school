export function LogoIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      ></path>
      <g fill="#DD2E44">
        <path d="M17 4v23l4-6l4 6V4z"></path>
        <path d="M25 28a1 1 0 0 1-.832-.445L21 22.803l-3.168 4.752A.998.998 0 0 1 16 27V4a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v23a1 1 0 0 1-1 1m-4-8c.334 0 .646.167.832.445L24 23.697V5h-6v18.697l2.168-3.252c.186-.278.498-.445.832-.445"></path>
      </g>
      <path fill="#F5F8FA" d="M15 2h12v2H15z"></path>
    </svg>
  );
}
